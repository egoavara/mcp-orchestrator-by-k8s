lazy_static::lazy_static! {
    static ref RESOURCE_UNAME_REGEX: regex::Regex = regex::Regex::new(r"^(?<type>[A-Za-z0-9]+)\.([A-Za-z0-9][-A-Za-z0-9_.]*)?[A-Za-z0-9]+/(?<name>([A-Za-z0-9][-A-Za-z0-9_.]*)?[A-Za-z0-9]+)$").unwrap();
}
