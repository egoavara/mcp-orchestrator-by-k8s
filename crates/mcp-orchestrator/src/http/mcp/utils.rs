...
use crate::{podmcp::PodMcpSessionManager, state::AppState};
...
pub(crate) async fn get_session_manager(
    state: &AppState,
    namespace: &str,
    name: &str,
) -> Result<PodMcpSessionManager, Response<BoxBody<Bytes, Infallible>>> {
