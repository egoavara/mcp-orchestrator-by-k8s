...
# Secret
grpcurl -plaintext -import-path ./spec -proto service.proto -d '{"name":"test-secret0","namespace":"test-ns","data":{"API_KEY":"c2VjcmV0","TOKEN":"dG9rZW4="},"labels":{"type":"api-b"}}' 127.0.0.1:3000 mcp.orchestrator.v1.McpOrchestratorService/CreateSecret
grpcurl -plaintext -import-path ./spec -proto service.proto -d '{"name":"test-secret1","namespace":"test-ns","data":{"API_KEY":"c2VjcmV0","TOKEN":"dG9rZW4="},"labels":{"type":"api-a"}}' 127.0.0.1:3000 mcp.orchestrator.v1.McpOrchestratorService/CreateSecret
...
grpcurl -plaintext -import-path ./spec -proto service.proto -d '{"name":"test-secret0","namespace":"test-ns"}' 127.0.0.1:3000 mcp.orchestrator.v1.McpOrchestratorService/DeleteSecret
grpcurl -plaintext -import-path ./spec -proto service.proto -d '{"name":"test-secret1","namespace":"test-ns"}' 127.0.0.1:3000 mcp.orchestrator.v1.McpOrchestratorService/DeleteSecret
...
grpcurl -plaintext -import-path ./spec -proto service.proto -d '{"name":"test-template0","namespace":"test-ns","image":"test-image","command":["/bin/mcp"],"args":["--port","8080"],"env_vars":[{"key":"LOG","value":"debug"}],"secret_env_vars":[{"name":"test-secret0"}],"resource_limit_name":"m0-nano","labels":{"app":"mcp"}}' 127.0.0.1:3000 mcp.orchestrator.v1.McpOrchestratorService/CreateMcpTemplate
grpcurl -plaintext -import-path ./spec -proto service.proto -d '{"name":"test-template1","namespace":"test-ns","image":"test-image","command":["/bin/mcp"],"env_vars":[{"key":"LOG","value":"debug"}],"resource_limit_name":"m0-nano","labels":{"app":"mcp"}}' 127.0.0.1:3000 mcp.orchestrator.v1.McpOrchestratorService/CreateMcpTemplate
grpcurl -plaintext -import-path ./spec -proto service.proto -d '{"name":"test-template2","namespace":"test-ns","image":"test-image","command":["/bin/mcp"],"args":["--port","8080"],"env_vars":[{"key":"LOG","value":"debug"}],"resource_limit_name":"unknown","labels":{"app":"mcp"}}' 127.0.0.1:3000 mcp.orchestrator.v1.McpOrchestratorService/CreateMcpTemplate
